...
import { KeywordsAndOntologyTermsReadView } from 'features/service/components/KeywordsAndOntologyTerms/ReadMode';
...
type ClassificationAndKeywordsReadViewProps = {
  language: Language;
  enabledLanguages: Language[];
  control: Control<ServiceModel>;
};

export function ClassificationAndKeywordsReadView(props: ClassificationAndKeywordsReadViewProps): React.ReactElement {
  ...
  return (
    <Box>
      ...
      <FormBlock>
        <KeywordsAndOntologyTermsReadView
          namespace={namespace}
          control={props.control}
