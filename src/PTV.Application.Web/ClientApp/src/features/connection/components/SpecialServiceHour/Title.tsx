...
import { getSpecialHourLvFieldName, toFieldId } from 'features/connection/utils/fieldid';
...
export function Title(props: TitleProps): React.ReactElement {
  ...
  function getFieldName(lang: Language): string {
    return getSpecialHourLvFieldName(props.hourIndex, lang, cHourLv.additionalInformation);
  }
  ...
  function renderRight(): React.ReactElement | null {
    ...
    return (
      <RhfTextInput
        ...
        mode='edit'
        labelText={t('Ptv.ConnectionDetails.SpecialServiceHour.Title')}
