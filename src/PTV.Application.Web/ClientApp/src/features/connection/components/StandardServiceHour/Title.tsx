...
import { getStdHourLvFieldName, toFieldId } from 'features/connection/utils/fieldid';
...
export function Title(props: TitleProps): React.ReactElement {
  ...
  function getFieldName(lang: Language): string {
    return getStdHourLvFieldName(props.hourIndex, lang, cHourLv.additionalInformation);
  }
  ...
  function renderRight(): React.ReactElement | null {
    ...
    return (
      <RhfTextInput
        ...
        mode='edit'
        labelText={t('Ptv.ConnectionDetails.StandardServiceHour.Title')}
