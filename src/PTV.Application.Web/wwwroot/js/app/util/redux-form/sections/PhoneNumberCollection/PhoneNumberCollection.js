...
const messages = defineMessages({
  ...
  phoneChannelFormPhoneNumberDisclaimer: {
    ...
    defaultMessage: 'Olet lisäämässä uuden puhelinnumeron. Voit lisätä uuden numeron vain, jos siinä annetaan palvelua puhelinkanavassa kuvattuun asiaan liittyen. Älä niputa samaan puhelinkanavaan kaikkia organisaation puhelinnumeroita, vaan tee jokaisesta asiasta oma puhelinkanava.',
    description: {
      ...
      sv: 'Du håller på att lägga till ett nytt telefonnummer. Du kan lägga till ett nytt nummer endast om det tillhör funktionen i telefonkanalens beskrivning. Samla inte organisationens alla nummer under samma telefonkanal. Varje skild funktion ska ha sin egen telefonkanal.'
    }
  },
