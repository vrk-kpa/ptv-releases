...
import Component from './AutoControlledComponent'
import Ref from './Ref'
...
class Portal extends Component {
  ...
  handleDocumentClick = (e) => {
    ...
    const isClosedIconClicked = e.target.className.includes('popupClose')
    ...
    if (((closeOnDocumentClick && !didClickInRootNode) || (closeOnRootNodeClick && didClickInRootNode)) || isClosedIconClicked) {
  ...
  renderPortal() {
    ...
    // if (this.portalNode) {
      // unsubscribe listeners for mouseleave and mouse event
    // }
    ...
    ReactDOM.unstable_renderSubtreeIntoContainer(
      ...
      () => {
        ...
        // register here mouse listeners for mouse enter and mouse leave
      },
    )
  }
  ...
  handleRef = c => (this.triggerNode = c) // eslint-disable-line react/no-find-dom-node
