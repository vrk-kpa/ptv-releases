...
namespace PTV.Application.Framework
{
    ...
    public class RequestFilteringMiddleware : IRequestFiltering
    {
        ...
        public RequestFilteringMiddleware(RequestDelegate next, string tag, IHttpContextAccessor httpContextAccessor, IConfigurationService configurationService, IOptions<RequestFilterAppSetting> appSettings)
        {
        ...
        public async Task Invoke(HttpContext httpContext, IUserIdentification userIdentification)
        {
            requestTotalCount++;
