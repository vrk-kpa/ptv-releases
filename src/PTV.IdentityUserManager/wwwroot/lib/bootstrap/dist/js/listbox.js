...
(function ($) {
    ...
    Listbox.prototype.addItem = function (parentItem) {
        ...
        var item = $('<div>')
            ...
            .attr('data-value', parentItem.val())
            .click(function () {
    ...
    MultiSelectListbox.prototype.onItemClick = function (item) {
        if (item.attr('disabled')) return;
        if (item.attr('callback_disabled')) return;
        ...
        if (item.attr('selected')) {
            ...
            if (this._settings.itemCB) {
              this._settings.itemCB('remove', item)
            }
            ...
            item.attr('selected', '');
            if (this._settings.itemCB) {
              this._settings.itemCB('add', item)
            }
            if (!parentValue)
                parentValue = [];
