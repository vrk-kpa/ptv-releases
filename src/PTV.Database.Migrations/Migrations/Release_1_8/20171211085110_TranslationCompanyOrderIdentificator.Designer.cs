...
namespace PTV.Database.Migrations.Migrations.Release_1_8
{
    ...
    [Migration("20171211085110_TranslationCompanyOrderIdentificator")]
    partial class TranslationCompanyOrderIdentificator
    {
        public void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.AuthorizationEntryPoint", b =>
                {
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_AutEntPoi_Id");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelAddress", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionId");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionId", "ServiceChannelId", "AddressId");

                    b.HasIndex("AddressId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaAdd_AddressId");

                    b.HasIndex("CharacterId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaAdd_CharacterId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId", "ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaAdd_StatutoryServiceGeneralDescriptionId_ServiceChannelId");

                    b.ToTable("GeneralDescriptionServiceChannelAddress");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelEmail", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionId");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionId", "ServiceChannelId", "EmailId");

                    b.HasIndex("EmailId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaEma_EmailId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId", "ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaEma_StatutoryServiceGeneralDescriptionId_ServiceChannelId");

                    b.ToTable("GeneralDescriptionServiceChannelEmail");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelPhone", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionId");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionId", "ServiceChannelId", "PhoneId");

                    b.HasIndex("PhoneId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaPho_PhoneId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId", "ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaPho_StatutoryServiceGeneralDescriptionId_ServiceChannelId");

                    b.ToTable("GeneralDescriptionServiceChannelPhone");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelServiceHours", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionId");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionId", "ServiceChannelId", "ServiceHoursId");

                    b.HasIndex("ServiceHoursId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaSerHou_ServiceHoursId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId", "ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaSerHou_StatutoryServiceGeneralDescriptionId_ServiceChannelId");

                    b.ToTable("GeneralDescriptionServiceChannelServiceHours");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelWebPage", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionId");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionId", "ServiceChannelId", "WebPageId");

                    b.HasIndex("WebPageId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaWebPag_WebPageId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId", "ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_GenDesSerChaWebPag_StatutoryServiceGeneralDescriptionId_ServiceChannelId");

                    b.ToTable("GeneralDescriptionServiceChannelWebPage");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelAddress", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.GeneralDescriptionServiceChannel", "GeneralDescriptionServiceChannel")
                        .WithMany("GeneralDescriptionServiceChannelAddresses")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelEmail", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.Email", "Email")
                        .WithMany("GeneralDescriptionServiceChannelEmails")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelPhone", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.Phone", "Phone")
                        .WithMany("GeneralDescriptionServiceChannelPhones")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelServiceHours", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.ServiceHours", "ServiceHours")
                        .WithMany("GeneralDescriptionServiceChannelServiceHours")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionServiceChannelWebPage", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.WebPage", "WebPage")
                        .WithMany("GeneralDescriptionServiceChannelWebPages")
