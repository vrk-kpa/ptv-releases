...
namespace PTV.Database.Migrations.Migrations
{
    ...
    [Migration("20170210101948_PTV_1_40")]
    partial class PTV_1_40
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.Organization", b =>
                {
                    ...
                    b.HasIndex("BusinessId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_BusinessId");

                    b.HasIndex("DisplayNameTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_DisplayNameTypeId");

                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_Org_Id");

                    b.HasIndex("MunicipalityId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_MunicipalityId");

                    b.HasIndex("Oid")
                        .HasAnnotation("Npgsql:Name", "IX_Org_Oid");

                    b.HasIndex("ParentId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_ParentId");

                    b.HasIndex("PublishingStatusId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_PublishingStatusId");

                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_TypeId");

                    b.HasIndex("UnificRootId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_UnificRootId");

                    b.HasIndex("VersioningId")
                        .HasAnnotation("Npgsql:Name", "IX_Org_VersioningId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationRootNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_OrgRooNod_Id");

                    b.ToTable("OrganizationRootNode");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationService", b =>
                {
                    ...
                    b.HasIndex("OrganizationId1")
                        .HasAnnotation("Npgsql:Name", "IX_OrgSer_OrganizationId1");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationType", b =>
                {
                    ...
                    b.HasIndex("ParentTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_OrgTyp_ParentTypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationTypeName", b =>
                {
                    ...
                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_OrgTypNam_TypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.Service", b =>
                {
                    ...
                    b.HasIndex("PublishingStatusId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_PublishingStatusId");

                    b.HasIndex("ServiceChargeTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_ServiceChargeTypeId");

                    b.HasIndex("ServiceCoverageTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_ServiceCoverageTypeId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_StatutoryServiceGeneralDescriptionId");

                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_TypeId");

                    b.HasIndex("UnificRootId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_UnificRootId");

                    b.HasIndex("VersioningId")
                        .HasAnnotation("Npgsql:Name", "IX_Ser_VersioningId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceCoverageType", b =>
                {
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_SerCovTyp_Id");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceCoverageTypeName", b =>
                {
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_SerCovTypNam_Id");

                    b.HasIndex("LocalizationId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCovTypNam_LocalizationId");

                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCovTypNam_TypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceChannel", b =>
                {
                    ...
                    b.HasIndex("OrganizationId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCha_OrganizationId");

                    b.HasIndex("PublishingStatusId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCha_PublishingStatusId");

                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCha_TypeId");

                    b.HasIndex("UnificRootId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCha_UnificRootId");

                    b.HasIndex("VersioningId")
                        .HasAnnotation("Npgsql:Name", "IX_SerCha_VersioningId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceChannelRootNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_SerChaRooNod_Id");

                    b.ToTable("ServiceChannelRootNode");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceLocationChannelServiceArea", b =>
                {
                    ...
                    b.HasIndex("MunicipalityId")
                        .HasAnnotation("Npgsql:Name", "IX_SerLocChaSerAre_MunicipalityId");

                    b.HasIndex("ServiceLocationChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerLocChaSerAre_ServiceLocationChannelId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceMunicipality", b =>
                {
                    ...
                    b.HasIndex("MunicipalityId")
                        .HasAnnotation("Npgsql:Name", "IX_SerMun_MunicipalityId");

                    b.HasIndex("ServiceVersionedId")
                        .HasAnnotation("Npgsql:Name", "IX_SerMun_ServiceVersionedId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceRootNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_SerRooNod_Id");

                    b.ToTable("ServiceRootNode");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannel", b =>
                {
                    ...
                    b.HasKey("ServiceVersionedId", "ServiceChannelId");
                    ...
                    b.HasIndex("ServiceVersionedId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerCha_ServiceVersionedId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.StatutoryServiceGeneralDescription", b =>
                {
                    ...
                    b.HasIndex("ChargeTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_ChargeTypeId");

                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_Id");

                    b.HasIndex("PublishingStatusId")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_PublishingStatusId");

                    b.HasIndex("TypeId")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_TypeId");

                    b.HasIndex("UnificRootId")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_UnificRootId");

                    b.HasIndex("VersioningId")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDes_VersioningId");

                    b.ToTable("StatutoryServiceGeneralDescription");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionRootNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("Id")
                        .HasAnnotation("Npgsql:Name", "IX_StaSerGenDesRooNod_Id");

                    b.ToTable("StatutoryServiceGeneralDescriptionRootNode");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ElectronicChannel", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.ServiceChannel", "ServiceChannelVersioned")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.GeneralDescriptionLanguageAvailability", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.StatutoryServiceGeneralDescription", "StatutoryServiceGeneralDescriptionVersioned")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.Organization", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.OrganizationRootNode", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                    ...
                    b.HasOne("PTV.Database.Model.Models.OrganizationRootNode", "UnificRoot")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationAddress", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.Organization", "OrganizationVersioned")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationService", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.Organization")
                        .WithMany("OrganizationServices")
                        .HasForeignKey("OrganizationId");

                    b.HasOne("PTV.Database.Model.Models.OrganizationRootNode", "Organization")
                        .WithMany()
                    ...
                    b.HasOne("PTV.Database.Model.Models.Service", "ServiceVersioned")
                        .WithMany("OrganizationServices")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationType", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.OrganizationType", "ParentType")
                        .WithMany()
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.Service", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionRootNode", "StatutoryServiceGeneralDescription")
                        .WithMany()
                    ...
                    b.HasOne("PTV.Database.Model.Models.ServiceRootNode", "UnificRoot")
                        .WithMany("Versions")
                        .HasForeignKey("UnificRootId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceChannel", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.ServiceChannelRootNode", "UnificRoot")
                        .WithMany("Versions")
                        .HasForeignKey("UnificRootId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannel", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.ServiceChannelRootNode", "ServiceChannel")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.StatutoryServiceGeneralDescription", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionRootNode", "UnificRoot")
                        .WithMany("Versions")
                        .HasForeignKey("UnificRootId")
                        .OnDelete(DeleteBehavior.Cascade);
