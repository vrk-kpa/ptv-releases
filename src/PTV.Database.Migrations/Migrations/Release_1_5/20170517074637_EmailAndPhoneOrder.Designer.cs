...
namespace PTV.Database.Migrations.Migrations.Release_1_5
{
    ...
    [Migration("20170517074637_EmailAndPhoneOrder")]
    partial class EmailAndPhoneOrder
    {
        public void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceWebPage", b =>
                {
                    b.Property<Guid>("ServiceVersonedId");
                    ...
                    b.HasKey("ServiceVersonedId", "WebPageId");

                    b.HasIndex("ServiceVersionedId")
                        .HasAnnotation("Npgsql:Name", "IX_SerWebPag_ServiceVersionedId");

                    b.HasIndex("ServiceVersonedId")
                        .HasAnnotation("Npgsql:Name", "IX_SerWebPag_ServiceVersonedId");
