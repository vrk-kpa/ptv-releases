...
namespace PTV.Database.Migrations.Migrations
{
    ...
    [Migration("20170213104540_OrganizationTypeToFinto")]
    partial class OrganizationTypeToFinto
    {
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationService", b =>
                {
                    ...
                    b.HasIndex("OrganizationVersionedId")
                        .HasAnnotation("Npgsql:Name", "IX_OrgSer_OrganizationVersionedId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationVersioned", b =>
                {
                    ...
                    b.HasIndex("DisplayNameTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_OrgVer_DisplayNameTypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceVersioned", b =>
                {
                    ...
                    b.HasIndex("ServiceCoverageTypeId")
                        .HasAnnotation("Npgsql:Name", "IX_SerVer_ServiceCoverageTypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.OrganizationService", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.OrganizationVersioned")
