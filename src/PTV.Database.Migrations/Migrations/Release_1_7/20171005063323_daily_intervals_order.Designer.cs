...
namespace PTV.Database.Migrations.Migrations.Release_1_7
{
    ...
    [Migration("20171005063323_daily_intervals_order")]
    partial class daily_intervals_order
    {
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelAddress", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaAdd_ServiceChannelId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaAdd_ServiceId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelEmail", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaEma_ServiceChannelId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaEma_ServiceId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelExtraType", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaExtTyp_ServiceChannelId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaExtTyp_ServiceId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelPhone", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaPho_ServiceChannelId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaPho_ServiceId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelServiceHours", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaSerHou_ServiceChannelId");

                    b.HasIndex("ServiceHoursId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaSerHou_ServiceHoursId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaSerHou_ServiceId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceServiceChannelWebPage", b =>
                {
                    ...
                    b.HasIndex("ServiceChannelId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaWebPag_ServiceChannelId");

                    b.HasIndex("ServiceId")
                        .HasAnnotation("Npgsql:Name", "IX_SerSerChaWebPag_ServiceId");
