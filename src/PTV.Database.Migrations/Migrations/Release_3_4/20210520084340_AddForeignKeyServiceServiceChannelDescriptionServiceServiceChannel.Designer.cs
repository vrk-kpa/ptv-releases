...
namespace PTV.Database.Migrations.Migrations.Release_3_4
{
    ...
    [Migration("20210520084340_AddForeignKeyServiceServiceChannelDescriptionServiceServiceChannel")]
    partial class AddForeignKeyServiceServiceChannelDescriptionServiceServiceChannel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.IndustrialClass", b =>
                {
                    ...
                    b.Property<string>("ParentYUri")
                        .HasColumnType("text");

                    b.Property<string>("Uri")
                        .HasColumnType("text");

                    b.Property<string>("YUri")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.IndustrialClassDescription", b =>
                {
                    ...
                    b.HasIndex("IndustrialClassId")
                        .HasName("IX_IndClaDes_IndustrialClassId");

                    b.HasIndex("LocalizationId")
                        .HasName("IX_IndClaDes_LocalizationId");

                    b.ToTable("IndustrialClassDescription");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.JobExecutionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_JobExeTyp_Id");

                    b.ToTable("JobExecutionType");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.JobExecutionTypeName", b =>
                {
                    b.Property<Guid>("TypeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LocalizationId")
                        .HasName("IX_JobExeTypNam_LocalizationId");

                    b.HasIndex("TypeId")
                        .HasName("IX_JobExeTypNam_TypeId");

                    b.ToTable("JobExecutionTypeName");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.JobLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("JobStatusTypeId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("JobSummaryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_JobLog_Id");

                    b.HasIndex("JobStatusTypeId")
                        .HasName("IX_JobLog_JobStatusTypeId");

                    b.HasIndex("JobSummaryId")
                        .HasName("IX_JobLog_JobSummaryId");

                    b.ToTable("JobLog");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.JobStatusType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_JobStaTyp_Id");

                    b.ToTable("JobStatusType");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.JobStatusTypeName", b =>
                {
                    b.Property<Guid>("TypeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LocalizationId")
                        .HasName("IX_JobStaTypNam_LocalizationId");

                    b.HasIndex("TypeId")
                        .HasName("IX_JobStaTypNam_TypeId");

                    b.ToTable("JobStatusTypeName");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.JobSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("JobExecutionTypeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_JobSum_Id");

                    b.HasIndex("JobExecutionTypeId")
                        .HasName("IX_JobSum_JobExecutionTypeId");

                    b.ToTable("JobSummary");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceCollectionServiceChannel", b =>
                {
                    b.Property<Guid>("ServiceCollectionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ServiceCollectionId", "ServiceChannelId");

                    b.HasIndex("ServiceChannelId")
                        .HasName("IX_SerColSerCha_ServiceChannelId");

                    b.HasIndex("ServiceCollectionId")
                        .HasName("IX_SerColSerCha_ServiceCollectionId");

                    b.ToTable("ServiceCollectionServiceChannel");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceVersioned", b =>
                {
                    ...
                    b.HasIndex("VoucherTypeId")
                        .HasName("IX_SerVer_VoucherTypeId");
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionKeyword", b =>
                {
                    b.Property<Guid>("StatutoryServiceGeneralDescriptionVersionedId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("StatutoryServiceGeneralDescriptionVersionedId", "KeywordId");

                    b.HasIndex("KeywordId")
                        .HasName("IX_StaSerGenDesKey_KeywordId");

                    b.HasIndex("StatutoryServiceGeneralDescriptionVersionedId")
                        .HasName("IX_StaSerGenDesKey_StatutoryServiceGeneralDescriptionVersionedId");

                    b.ToTable("StatutoryServiceGeneralDescriptionKeyword");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.TrackingServiceCollectionServiceChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_TraSerColSerCha_Id");

                    b.ToTable("TrackingServiceCollectionServiceChannel");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.Versioning", b =>
                {
                    ...
                    b.HasIndex("UnificRootId")
                        .HasName("IX_Ver_UnificRootId");

                    b.ToTable("Versioning");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.VoucherType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id")
                        .HasName("IX_VouTyp_Id");

                    b.ToTable("VoucherType");
                });

            modelBuilder.Entity("PTV.Database.Model.Models.VoucherTypeName", b =>
                {
                    b.Property<Guid>("TypeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LocalizationId")
                        .HasName("IX_VouTypNam_LocalizationId");

                    b.HasIndex("TypeId")
                        .HasName("IX_VouTypNam_TypeId");

                    b.ToTable("VoucherTypeName");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.JobExecutionTypeName", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.JobExecutionType", "Type")
                        .WithMany("Names")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.JobLog", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.JobStatusType", "JobStatusType")
                        .WithMany()
                        .HasForeignKey("JobStatusTypeId");

                    b.HasOne("PTV.Database.Model.Models.JobSummary", "JobSummary")
                        .WithMany("JobLogs")
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.JobStatusTypeName", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.JobStatusType", "Type")
                        .WithMany("Names")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.JobSummary", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.JobExecutionType", "JobExecutionType")
                        .WithMany()
                        .HasForeignKey("JobExecutionTypeId");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ProvisionType", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.ProvisionType", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceCollectionServiceChannel", b =>
                {
                    b.HasOne("PTV.Database.Model.Models.ServiceChannel", "ServiceChannel")
                        .WithMany("ServiceCollectionServiceChannels")
                        .HasForeignKey("ServiceChannelId")
                        .HasConstraintName("FK_SerColSerCha_ServiceChannel_ServiceChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("PTV.Database.Model.Models.ServiceCollection", "ServiceCollection")
                        .WithMany("ServiceCollectionServiceChannels")
                        .HasForeignKey("ServiceCollectionId")
                        .HasConstraintName("FK_SerColSerCha_ServiceCollection_ServiceCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.ServiceVersioned", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.VoucherType", "VoucherType")
                        .WithMany()
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionKeyword", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.StatutoryServiceGeneralDescriptionVersioned", "StatutoryServiceGeneralDescriptionVersioned")
                        .WithMany("Keywords")
                        .HasForeignKey("StatutoryServiceGeneralDescriptionVersionedId")
                        .HasConstraintName("FK_StaSerGenDesKey_StatutoryServiceGeneralDescriptionVersioned_StatutoryServiceGeneralDescriptionVersionedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PTV.Database.Model.Models.VoucherTypeName", b =>
                {
                    ...
                    b.HasOne("PTV.Database.Model.Models.VoucherType", "Type")
                        .WithMany("Names")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
