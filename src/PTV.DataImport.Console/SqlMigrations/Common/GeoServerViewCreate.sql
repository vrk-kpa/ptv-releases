...
JOIN "Language" lan ON scwp."LocalizationId" = lan."Id";
...
select 
	...
	cap."StreetNumber",
	casn."Name" as "StreetName",
	pco."Code" as "PostalCode",
	pcn."Name" as "PostalName",
    coalesce(casn."Name", '') || ' ' || coalesce(cap."StreetNumber", '') || ', ' || coalesce(pco."Code", '') || ', ' || coalesce(pcn."Name", '') as "AddressText"
from "ClsAddressPoint" cap
join "ClsAddressStreetName" casn on cap."AddressStreetId" = casn."ClsAddressStreetId"
join "Language" lan on casn."LocalizationId" = lan."Id"
join "PostalCode" pco on cap."PostalCodeId" = pco."Id"
left join "PostalCodeName" pcn on cap."PostalCodeId" = pcn."PostalCodeId" and lan."Id" = pcn."LocalizationId"
;
