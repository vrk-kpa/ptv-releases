...
module Defaults =  
  ...
  let eChannelSummary = "on apteekin etäasiointikanava, josta voi ostaa lääkkeitä, apteekkituotteita ja muita palveluita sekä tutustua tuotteisiin ja lääketietoon."
