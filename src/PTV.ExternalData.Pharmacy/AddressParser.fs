    ...
    ServiceLocationJson.Address
      (
        ...
        streetAddress = ServiceLocationJson.StreetAddress
                        (
                          street = [| CommonParser.createLocalizedText streetName Defaults.textLengths.StreetName |],
                          streetNumber = streetNumber,
                          postalCode = CommonParser.removeWhitespaces (input.Postinumero.String |? ""),
                          municipality = "",
                          additionalInformation = CommonParser.parseAdditionalInfo additionalInfo Defaults.textLengths.StreetAdditionalInfo,
                          longitude = "",
                          latitude = ""
                        ),
          otherAddress = None,
