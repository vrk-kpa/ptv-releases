...
cp ${SECURITY}/${ENVIRONMENT}/masterpw.digest ${GEOSERVER_DATA_DIR}/security/
cp ${SECURITY}/${ENVIRONMENT}/geoserver.jceks ${GEOSERVER_DATA_DIR}/security/
cp ${SECURITY}/${ENVIRONMENT}/passwd ${GEOSERVER_DATA_DIR}/security/masterpw/default/
rm ${SECURITY} -rf
