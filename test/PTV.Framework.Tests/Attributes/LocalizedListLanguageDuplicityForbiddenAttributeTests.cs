...
namespace PTV.Framework.Tests.Attributes
{
    public class LocalizedListLanguageDuplicityForbiddenAttributeTests
    {
        ...
        public void ValidationShouldHandleNullItem()
        {
            ...
            act.ShouldThrowExactly<ValidationException>().WithMessage("List item cannot be null.");
        }
        ...
        public void ValidationShouldHandleNullPropertyValue()
        {
            ...
            act.ShouldThrowExactly<ValidationException>().WithMessage("Property value cannot be null.");
        }
        ...
        public void PropertyNameWhitespacesShouldThrow()
        {
            ...
            act.ShouldThrowExactly<ValidationException>().WithMessage("Unknown property:   "); // notice the two whitespaces as the property name
        }
